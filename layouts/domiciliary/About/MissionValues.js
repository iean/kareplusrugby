    ...
    <div className="container grid md:grid-cols-2 gap-10 items-center">
      ...
      <div className="space-y-4">
        <div className="p-6 bg-white border rounded-xl shadow">
          ...
          <p className="text-base text-gray-600">We tailor care plans around each individual's needs.</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow">
          <h3 className="font-semibold text-primary-800 mb-1">Trusted Carers</h3>
          <p className="text-base text-gray-600">All staff are fully trained and background checked.</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow">
          <h3 className="font-semibold text-primary-800 mb-1">Ongoing Support</h3>
          <p className="text-base text-gray-600">We communicate regularly to ensure happiness and wellbeing.</p>
        </div>
      </div>
    </div>
  </section>
