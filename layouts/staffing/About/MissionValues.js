    ...
    <div className="container grid md:grid-cols-2 gap-10 items-center">
      ...
      <div className="space-y-4">
        <div className="p-6 bg-white border rounded-xl shadow">
          ...
          <p className="text-base text-gray-600">All candidates undergo comprehensive vetting.</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow">
          <h3 className="font-semibold text-primary-800 mb-1">Responsive Support</h3>
          <p className="text-base text-gray-600">Our team is available 24/7 for urgent requests.</p>
        </div>
        <div className="p-6 bg-white border rounded-xl shadow">
          <h3 className="font-semibold text-primary-800 mb-1">Nationwide Cover</h3>
          <p className="text-base text-gray-600">We place professionals across the UK.</p>
        </div>
      </div>
    </div>
  </section>
