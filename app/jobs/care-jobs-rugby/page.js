 ...
 */
const area = getArea("care-jobs-rugby");

export const metadata = {
  title: area.title,
  description: area.metaDescription,
  alternates: { canonical: "/jobs/care-jobs-rugby" },
  openGraph: og({ title: area.title, description: area.metaDescription, url: "/jobs/care-jobs-rugby" }),
};
